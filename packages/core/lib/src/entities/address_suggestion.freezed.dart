...
/// @nodoc
@JsonSerializable()
class _$AddressSuggestionImpl extends _AddressSuggestion {
  const _$AddressSuggestionImpl({required this.id, required this.text})
      : super._();
  ...
  @override
  String toString() {
    return 'AddressSuggestion(id: $id, text: $text)';
  }
...
abstract class _AddressSuggestion extends AddressSuggestion {
  const factory _AddressSuggestion(
      {required final String id,
      required final String text}) = _$AddressSuggestionImpl;
  const _AddressSuggestion._() : super._();
